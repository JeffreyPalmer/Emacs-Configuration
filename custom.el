(custom-set-variables
 ...
 '(sql-clickhouse-login-params
   '((user :default "explorer")
     password
     (server :default "gh-api.clickhouse.tech")))
 '(sql-clickhouse-options nil)
 '(sql-clickhouse-program "clickhouse-docker-client.sh")
 '(tool-bar-mode nil)
