...
Use [[https://github.com/renzmann/treesit-auto][treesite-auto]] to manage this stuff for me.

Turns out, this stuff is not ready for prime time, at least not for my
current needs. I'm disabling and will perhaps revisit in the next
major release.
...
#+begin_src emacs-lisp
  (use-package typescript-mode
    :mode "\\.ts\\'"
    :config
    ;; if we're using this configuration, don't activate treesitter
