...
#+begin_src emacs-lisp
  (use-package tab-bar
    ...
    (tab-bar-mode 1))
#+end_src
** Window layouts via activities.el
...
Try using [[https://github.com/bmag/emacs-purpose][emacs-purpose]] to manage my window layouts/etc. This did not
(easily) do what I wanted. At least, not enough to keep it around.
