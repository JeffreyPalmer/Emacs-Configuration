...
Specify that I want my window frame without a title bar.
#+begin_src emacs-lisp :tangle /Users/jeff/.config/emacs/early-init.el
...
#+begin_src emacs-lisp
  ...
  ;; Use the ligatures.el package if we're not on emacs-mac
...
#+begin_src emacs-lisp
  (use-package treesit-auto
    ...
    ;; Try allowing these to be automatically installed?
    ;; (treesit-auto-langs '(javascript typescript))
    :config
